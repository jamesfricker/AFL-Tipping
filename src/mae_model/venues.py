...
VENUE_METADATA: Dict[str, VenueMeta] = {
    ...
    "carrara": VenueMeta("Carrara", -28.0064, 153.3669, "Australia/Brisbane", 159.0, 134.0, 27000.0),
    ...
    "summitsportspark": VenueMeta(
        "Summit Sports Park", -35.0754, 138.8943, "Australia/Adelaide", 160.0, 130.0, 5000.0
    ),
